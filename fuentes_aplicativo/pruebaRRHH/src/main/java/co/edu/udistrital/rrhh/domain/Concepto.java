...
@RooToString(excludeFields = { "conPago", "pagoes" })
public class Concepto implements Serializable{
	...
	public String toString() {
        return new ReflectionToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).setExcludeFieldNames("conPago", "pagoes").toString();
    }

	@OneToMany(mappedBy = "conConcepto")
