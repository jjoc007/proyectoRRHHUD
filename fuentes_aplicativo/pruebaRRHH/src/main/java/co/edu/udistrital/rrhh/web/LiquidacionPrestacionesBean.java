...
@ManagedBean(name = "liquidacionPrestacionesBean")
@SessionScoped
@Configurable
@RooSerializable
@RooJsfManagedBean(entity = Empleado.class, beanName = "liquidacionPrestacionesBean")
public class LiquidacionPrestacionesBean implements Serializable {
	...
	public void liquidar(){
		...
		try {
			...
			StringBuffer alertasVacaciones = prestacionService.liquidarPrestaciones(allEmpleados, periodo);
